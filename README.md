...
This is a [HUGO](https://gohugo.io/) website, using [GitHub Pages](https://pages.github.com/) to host the website. Animations courtesy of [Vanta.js](https://github.com/tengbao/vanta). The theme is Paper++, a customized version of [PaperMod](https://github.com/adityatelange/hugo-PaperMod), which I intend to fork and make public in the future.
